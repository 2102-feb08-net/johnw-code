...
namespace EFDemo.DataAccess
{
    public partial class ChinookContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("Department", "ex1");

                entity.HasIndex(e => e.Id, "UQ__Departme__3214EC268122D8D3")
                    .IsUnique();
            ...
            modelBuilder.Entity<EmpDetail>(entity =>
            {
                ...
                entity.HasOne(d => d.Employee)
                    ...
                    .HasConstraintName("FK_EmpDetails_Employee");
            });
            ...
            {
                entity.ToTable("Employee", "ex1");

                entity.HasIndex(e => e.Ssn, "UQ__Employee__CA1E8E3CD13409E6")
                    .IsUnique();
